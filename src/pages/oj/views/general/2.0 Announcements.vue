<template>
  <Row type="flex" :gutter="18">
    ...
    <Col :span="containerSpan" >
      <div>
        <el-carousel :interval="5000" type="card" style="min-width: 1000px; max-width: 1400px;" height="bannerHeight+'px'">
        ...
        <el-carousel-item v-if="images[1]">
          <a href="https://hdnoip.com/Forum"><img src="/public/upload/forum.png" alt=""></a>
        </el-carousel-item>
        </el-carousel>
...
<script>
  ...
  export default {
    ...
    mounted () {
      ...
      this.getExtraImage('/../public/upload/forum.png')
      this.imgLoad()
