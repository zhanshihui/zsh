  ...
  <div v-if="website.allow_forum_post" class="flex-container">
    <div id="forumpost-main">
      ...
      <Panel :padding="40" shadow>
        ...
        <div id="forumpost-content" style="max-width: 1100px; word-wrap:break-word; word-break:break-all; overflow: hidden;" class="markdown-body" v-katex>
      ...
      <Panel :padding="40" shadow style="margin-top: 20px;">
        ...
        <div style="margin-top: -30px; margin-bottom: 30px">
          <Card :padding="20" dis-hover v-for="reply in forumreplys"
            ...
            <div id="forumreply-content" style="max-width: 1100px; word-wrap:break-word; word-break:break-all; overflow: hidden;" class="markdown-body" v-katex>
